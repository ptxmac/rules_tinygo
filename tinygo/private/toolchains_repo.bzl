...
# By default all these toolchains are registered by the tinygo_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:tinygo_toolchain",
    toolchain_type = "@rules_tinygo//tinygo:toolchain_type",
)
""".format(
            platform = platform,
