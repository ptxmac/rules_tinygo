...
some other ruleset that depends on rules_tinygo, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_tinygo=$(pwd)/rules_tinygo"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_tinygo` on your system will point to this folder.
